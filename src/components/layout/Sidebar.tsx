          ...
          <div className="pt-4">
            ...
            {userRole === 'ADMIN' && municipalityId && (
              <>
                ...
                <Link
                  href={`/admin/municipalidades/${municipalityId}/categorias`}
                  className={navLinkClass(`/admin/municipalidades/${municipalityId}/categorias`)}
                >
                  <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <Link
                  href={`/admin/municipalidades/${municipalityId}/unidades`}
                  className={navLinkClass(`/admin/municipalidades/${municipalityId}/unidades`)}
                >
                  <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a4 4 0 00-3-3.87M9 20H4v-2a4 4 0 013-3.87m6-4a4 4 0 10-4-4m9 8a4 4 0 10-4-4" />
                  </svg>
