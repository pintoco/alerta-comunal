    ...
    <MainLayout>
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <Link href="/admin/auditoria" className="card p-6 hover:shadow-md transition-shadow group">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-gray-500 text-xs">Login fallidos, eliminaciones, correos</p>
              </div>
            </div>
          </Link>
        </div>
