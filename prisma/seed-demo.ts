 ...
 * nunca debe correr contra un entorno con datos reales.
 */
export default async function seedDemo() {
  ...
  console.log('')
  console.log('Seed de demostración completado. Credenciales (SOLO desarrollo local):')
  ...
  console.log('')
  console.log('⚠ Estas contraseñas son públicas (código fuente). Nunca usar SEED_DEMO=true contra datos reales.')
